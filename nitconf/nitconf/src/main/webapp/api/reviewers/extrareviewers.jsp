...
<head>
    ...
    function assignReviewers() {
        ...
        form.action = "/api/reviewers/assignextrareviewers";
        form.method = "post";
...
<%@include file="/api/pcmember/dashboard.jsp"%>
    ...
    <div class="container">
        <h2>Assign Additional Reviewers for paper : <%=paper_title%></h2></div>
        <form id="assignForm">
            <table border="1">
                <thead>
                    <tr>
                ...
                <tbody id="tableBody">
                    <%
                    List<Reviewer> list = (List<Reviewer>) request.getAttribute("extra_reviewers");
